...
import { NavLink ,Pill} from 'react-router-dom';
...
<div className="tabcontenido">
        ...
        <Tabs className="flex-column btnContenido" defaultActiveKey="Almuerzos"  >
          <Tab eventKey="Almuerzos" title="Almuerzos"  className="btnTab" >
            <h1>Almuerzos</h1>
           
          </Tab>
          <Tab eventKey="Bco.Alimentos" title="Bco. Alimentos" className="btnTab">
            <DetailAlimentos/>

          </Tab>
          <Tab eventKey="Capacitaciones" title="Capacitaciones" className="btnTab">
            <DetailCapacitaciones/>
          </Tab>
          <Tab eventKey="Colaboradores" title="Colaboradores" className="btnTab">
            <h1>Colaboradores</h1>
          </Tab>
          <Tab eventKey="HuertosUrbanos" title="Huertos Urbanos" className="btnTab" className="btnTab">
            <DetailHuertos/>
          </Tab>
          <Tab eventKey="Navidad" title="Navidad"className="btnTab" className="btnTab">
            <h1>Navidad </h1>
          </Tab>
          <Tab eventKey="Voluntariado" title="Voluntariado" className="btnTab">
            <h1>Voluntariado </h1>
          </Tab>
