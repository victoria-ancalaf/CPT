      ...
      <Carousel>
        <Carousel.Item>
          ...
          <Carousel.Caption className="carouselMensaje">
            <div class="container ">
              <p>
                Regala una cena en esta <strong>Navidad</strong>. Escribamos
                juntos <strong>la receta para un mejor país</strong>.
              </p>
        ...
        <Carousel.Item>
          <img className="imagenheader2" src={carousel} alt="Second slide" />
          <Carousel.Caption className="carouselMensaje">
            <div class="container ">
              <p>
                Puedes aportar con un <strong>almuerzo solidario </strong> por
                solo <strong>$3.000 CLP</strong>
              </p>
              <button type="button" className="btn btn-ttc">
