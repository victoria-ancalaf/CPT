      ...
      <div className="footer-meddle">
        <div className="main-container px-lg-4 pt-5 pb-6">
          ...
          <div className="contacto">
            <ul className="list-unstyled">
              <div>
                <h1 className="titulofot">
                  {" "}
                  Escríbenos, <strong> te leemos</strong>
                </h1>
              </div>

              <li>
                <input className="nombrefot" placeholder="Nombre Completo"></input>
              </li>
              <li>
                <input
                  className="mail"
            ...
            <div className="redesSociales">
              <li className="instagramPrueba list-unstyled">
                <a href="https://www.instagram.com/comida_para_todos_cl/">
                  <img className="instagram" src={iconInstagram} alt="" />
                </a>
                <li className="emailPrueba">
                  <img className="email" src={iconEmail} alt="" />
                </li>
                <li className="whatsappPrueba">
                  <img className="whatsapp" src={iconWhatsapp} alt="" />
                </li>
        ...
        <p className="parrafo text-xs-center">
          &copy;{new Date().getFullYear()} Comida para todos - Todos los
          derechos reservados 
